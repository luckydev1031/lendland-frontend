...
const getValueString = ({ lela, valueMantissa }: { valueMantissa?: BigNumber; lela?: Token }) =>
  valueMantissa &&
  lela &&
...
export const ActiveVotingProgress: React.FC<ActiveVotingProgressProps> = ({
  ...
  const activeProposalVotingData = useMemo(
    () => [
      {
        id: 'for',
        label: t('vote.for'),
        value: getValueString({ valueMantissa: votedForMantissa, lela }),
        progressBarProps: {
      ...
      },
      {
        ...
        value: getValueString({ valueMantissa: votedAgainstMantissa, lela }),
        progressBarProps: {
      ...
      },
      {
        ...
        value: getValueString({ valueMantissa: abstainedMantissa, lela }),
        progressBarProps: {
    ...
    [votedForMantissa, votedAgainstMantissa, abstainedMantissa, lela, votedTotalMantissa, t],
  );
