      ...
      <div css={styles.dataRowList} data-testid={TEST_IDS.assetTable}>
        {sortedAssets.map(asset => (
          <div
            ...
            key={`isolated-asset-warning-asset-table-data-row-${asset.leToken.underlyingToken.address}`}
          >
            <div css={styles.cell}>
              <TokenIconWithSymbol token={asset.leToken.underlyingToken} className="text-sm" />
            </div>
