...
export const CollateralConfirmModal: React.FC<ConfirmCollateralModalProps> = ({
  ...
  const title = asset?.isCollateralOfUser
    ? t('markets.collateralConfirmModal.disable', { asset: asset?.leToken.underlyingToken.symbol })
    : t('markets.collateralConfirmModal.enable', { asset: asset?.leToken.underlyingToken.symbol });
