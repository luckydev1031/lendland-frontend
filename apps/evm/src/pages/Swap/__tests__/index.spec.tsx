...
import { bnb, wbnb, lela } from '__mocks__/models/tokens';
...
describe('Swap', () => {
  ...
  it('displays user fromToken and toToken balances correctly', async () => {
    ...
    await waitFor(() => expect(getByText('10.00K LELA')));
  });
  ...
  it('updates toToken when changing fromToken for toToken', () => {
    ...
    // Since the initial toToken is LELA, we change fromToken for LELA
    selectToken({
      container,
