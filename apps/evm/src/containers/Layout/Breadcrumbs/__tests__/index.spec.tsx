...
import leTokens from '__mocks__/models/leTokens';
  ...
  it.each([
    ...
    [
      routes.isolatedPoolMarket.path
        ...
        .replace(':vTokenAddress', poolData[0].assets[0].leToken.address),
      routes.isolatedPoolMarket.path,
    ],
    [routes.corePool.path, routes.corePool.path],
    [
      routes.corePoolMarket.path.replace(':vTokenAddress', poolData[0].assets[0].leToken.address),
      routes.corePoolMarket.path,
    ],
    [routes.lela.path, routes.lela.path],
