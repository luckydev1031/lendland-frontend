...
const useGetGroups = ({ uncheckedGroupIds }: { uncheckedGroupIds: string[] }) => {
  ...
  return useMemo(
          ...
          if (
            ...
            const id =
              pendingRewardGroup.type === 'vault'
                ...
                : `lela-vesting-vault-${pendingRewardGroup.rewardToken.asset}-${pendingRewardGroup.poolIndex}`;
    ...
    [getPendingRewardsData?.pendingRewardGroups, uncheckedGroupIds, getPoolsData?.pools, lela, t],
  );
};
