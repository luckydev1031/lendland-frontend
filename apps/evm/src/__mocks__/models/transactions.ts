import leTokens, { vUsdt } from '__mocks__/models/leTokens';

import formatTransaction from 'clients/api/queries/getTransactions/formatTransaction';
import type { TransactionResponse } from 'clients/api/queries/getTransactions/types';
import type { Transaction } from 'types';

import tokens, { busd, lela } from './tokens';
...
const transactions = transactionResponse.reduce((acc, data) => {
  const transaction = formatTransaction({ data, leTokens, tokens, defaultToken: lela });
