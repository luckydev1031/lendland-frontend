...
import { bnb, busd, luna, usdc, usdt, ust, weth, lela } from './tokens';

export const vXvs: LeToken = {
  address: '0x6d6F697e34145Bb95c54E77482d97cc261Dc237E',
  decimals: 8,
  symbol: 'vXVS',
  underlyingToken: lela,
};

export const vBnb: LeToken = {
