...
export class XVSProxyOFTSrc__factory {
  static readonly abi = _abi;
  static createInterface(): XVSProxyOFTSrcInterface {
    return new utils.Interface(_abi) as XVSProxyOFTSrcInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XVSProxyOFTSrc {
    return new Contract(address, _abi, signerOrProvider) as XVSProxyOFTSrc;
  }
}
