...
export interface VrtConverterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setXVSVesting",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "xvsDecimalsMultiplier",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "xvsVesting",
    values?: undefined
  ): string;
...
export interface VrtConverter extends BaseContract {
  ...
  filters: {
    ...
    "XVSVestingSet(address)"(
      xvsVestingAddress?: null
    ): XVSVestingSetEventFilter;
