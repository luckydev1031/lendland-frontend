...
export declare namespace XVSVaultStorageV1 {
  ...
  export type WithdrawalRequestStructOutput = [
    ...
    BigNumber,
    BigNumber
  ] & { amount: BigNumber; lockedUntil: BigNumber; afterUpgrade: BigNumber };
}
...
export interface XvsVaultInterface extends utils.Interface {
  functions: {
    ...
    "primePoolId()": FunctionFragment;
    "primeRewardToken()": FunctionFragment;
    ...
    "setPrimeToken(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isStakedToken",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "pendingRewardTransfers",
  ...
  encodeFunctionData(
    functionFragment: "pendingXVSVaultImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "primePoolId",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "primeRewardToken",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "primeToken",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "primeToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "requestWithdrawal",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "NewPrimeToken(address,address,address,address,uint256,uint256)": EventFragment;
...
export interface NewPrimeTokenEventObject {
  ...
  oldPrimeRewardToken: string;
  newPrimeRewardToken: string;
  oldPrimePoolId: BigNumber;
  newPrimePoolId: BigNumber;
}
...
export type VaultDebtUpdatedEventFilter =
  TypedEventFilter<VaultDebtUpdatedEvent>;
...
export interface XvsVault extends BaseContract {
  ...
  functions: {
    ...
    primePoolId(overrides?: CallOverrides): Promise<[BigNumber]>;

    primeRewardToken(overrides?: CallOverrides): Promise<[string]>;

    primeToken(overrides?: CallOverrides): Promise<[string]>;
    ...
    setPrimeToken(
      _primeToken: string,
      _primeRewardToken: string,
      _primePoolId: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "NewPrimeToken(address,address,address,address,uint256,uint256)"(
      oldPrimeToken?: string | null,
      newPrimeToken?: string | null,
      oldPrimeRewardToken?: null,
      newPrimeRewardToken?: null,
      oldPrimePoolId?: null,
      newPrimePoolId?: null
  ...
  estimateGas: {
    ...
    primeRewardToken(overrides?: CallOverrides): Promise<BigNumber>;

    primeToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    primePoolId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    primeRewardToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    primeToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
