...
import type {
  ...
  IsolatedPoolComptrollerInterface,
} from "../IsolatedPoolComptroller";
...
export class IsolatedPoolComptroller__factory {
  static readonly abi = _abi;
  static createInterface(): IsolatedPoolComptrollerInterface {
    return new utils.Interface(_abi) as IsolatedPoolComptrollerInterface;
  }
  static connect(
    address: string,
