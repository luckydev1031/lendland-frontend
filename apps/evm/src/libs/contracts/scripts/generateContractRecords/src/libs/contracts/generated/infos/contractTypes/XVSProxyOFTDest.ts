...
export interface XVSProxyOFTDestInterface extends utils.Interface {
  functions: {
...
export interface XVSProxyOFTDest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XVSProxyOFTDestInterface;
