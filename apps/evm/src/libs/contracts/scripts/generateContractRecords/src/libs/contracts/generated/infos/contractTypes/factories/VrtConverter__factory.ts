...
import type { VrtConverter, VrtConverterInterface } from "../VrtConverter";
...
export class VrtConverter__factory {
  static readonly abi = _abi;
  static createInterface(): VrtConverterInterface {
    return new utils.Interface(_abi) as VrtConverterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VrtConverter {
    return new Contract(address, _abi, signerOrProvider) as VrtConverter;
  }
}
