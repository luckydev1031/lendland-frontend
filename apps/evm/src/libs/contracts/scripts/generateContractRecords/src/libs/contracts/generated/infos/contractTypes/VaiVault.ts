...
export interface VaiVaultInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "accXVSPerShare",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "pendingVAIVaultImplementation",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "vaiVaultImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "lela", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "xvsBalance",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "lela", data: BytesLike): Result;
...
export interface VaiVault extends BaseContract {
  ...
  functions: {
    ...
    lela(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    lela(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lela(overrides?: CallOverrides): Promise<PopulatedTransaction>;
