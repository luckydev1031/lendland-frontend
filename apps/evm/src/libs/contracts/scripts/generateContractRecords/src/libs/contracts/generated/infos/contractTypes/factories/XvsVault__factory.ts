...
import type { XvsVault, XvsVaultInterface } from "../XvsVault";
...
export class XvsVault__factory {
  static readonly abi = _abi;
  static createInterface(): XvsVaultInterface {
    return new utils.Interface(_abi) as XvsVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XvsVault {
    return new Contract(address, _abi, signerOrProvider) as XvsVault;
  }
}
