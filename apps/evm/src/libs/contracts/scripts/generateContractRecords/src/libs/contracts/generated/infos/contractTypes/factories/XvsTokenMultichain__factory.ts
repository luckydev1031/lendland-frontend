...
import type {
  XvsTokenMultichain,
  XvsTokenMultichainInterface,
} from "../XvsTokenMultichain";
...
export class XvsTokenMultichain__factory {
  static readonly abi = _abi;
  static createInterface(): XvsTokenMultichainInterface {
    return new utils.Interface(_abi) as XvsTokenMultichainInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XvsTokenMultichain {
    return new Contract(address, _abi, signerOrProvider) as XvsTokenMultichain;
  }
}
