...
import type { VaiController, VaiControllerInterface } from "../VaiController";
...
export class VaiController__factory {
  static readonly abi = _abi;
  static createInterface(): VaiControllerInterface {
    return new utils.Interface(_abi) as VaiControllerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VaiController {
    return new Contract(address, _abi, signerOrProvider) as VaiController;
  }
}
