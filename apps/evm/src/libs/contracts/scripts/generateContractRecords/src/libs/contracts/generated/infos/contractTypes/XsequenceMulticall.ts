...
export declare namespace RequireUtils {
  export type MemberStruct = { weight: BigNumberish; signer: string };
...
export interface XsequenceMulticallInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, RequireUtils.MemberStruct[], boolean]
  ): string;
  encodeFunctionData(
...
export interface XsequenceMulticall extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XsequenceMulticallInterface;
