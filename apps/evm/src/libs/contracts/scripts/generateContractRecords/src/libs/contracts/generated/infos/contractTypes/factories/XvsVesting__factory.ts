...
import type { XvsVesting, XvsVestingInterface } from "../XvsVesting";
...
export class XvsVesting__factory {
  static readonly abi = _abi;
  static createInterface(): XvsVestingInterface {
    return new utils.Interface(_abi) as XvsVestingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XvsVesting {
    return new Contract(address, _abi, signerOrProvider) as XvsVesting;
  }
}
