...
import type {
  XVSProxyOFTDest,
  XVSProxyOFTDestInterface,
} from "../XVSProxyOFTDest";
...
export class XVSProxyOFTDest__factory {
  static readonly abi = _abi;
  static createInterface(): XVSProxyOFTDestInterface {
    return new utils.Interface(_abi) as XVSProxyOFTDestInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XVSProxyOFTDest {
    return new Contract(address, _abi, signerOrProvider) as XVSProxyOFTDest;
  }
}
